...
const messages = {
  ...
  de: {
    ...
    authPage: {
      ...
      otpPlaceholder: '123456',
      verifyOtpTitle: 'Code bestätigen',
      verifyOtpSubtitle: 'Geben Sie den 6-stelligen Code ein, der an Ihre E-Mail gesendet wurde.',
      verifyOtpButton: 'Code bestätigen',
      newPasswordLabel: 'Neues Passwort',
      newPasswordTitle: 'Neues Passwort festlegen',
      newPasswordSubtitle: 'Geben Sie unten Ihr neues Passwort ein.',
